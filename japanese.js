...
function renderJapanese(doc){
    ...
    cross.addEventListener('click', (e) => {
        ...
        //delete the element
        db.collection('japanese').doc(id).delete();
    });
}
...
db.collection('japanese').onSnapshot(snapshot => {
